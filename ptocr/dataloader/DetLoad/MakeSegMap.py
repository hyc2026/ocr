...
import cv2
import pyclipper
from shapely.geometry import Polygon  # 实现任意多边形IoU计算
import numpy as np
...
class MakeSegMap:
    ...
    def process(self, img,polys,dontcare):
        ...
        for i in range(len(polys)):
            ...
            if dontcare[i] or min(height, width) < self.min_text_size:
                ...
                # newaxis新增一维
                '''
                [[585.05089188 127.9370064 ]
                 [639.         120.94262749]
                 [639.         145.7770161 ]
                 [589.36883    152.77139502]]
                [[[585 127]
                  [639 120]
                  [639 145]
                  [589 152]]]
    ...
    def validate_polygons(self, polygons, ignore_tags, h, w):
        ...
        for polygon in polygons:
            # np.clip(a, b, c) 将数组a的值限制在[b, c]之间
    ...
    def polygon_area(self, polygon):
        ...
        for i in range(polygon.shape[0]):
            next_index = (i + 1) % polygon.shape[0]  # 首尾相连
