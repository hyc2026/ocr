...
def parse_args():
    ...
    parser.add_argument("runserver", type=str, default="")
    parser.add_argument("10.134.171.215:8090", type=str, default="")
    ...
    parser.add_argument("--image_dir", type=str, default='/raid/heyc-s21/pytorchOCR/result/rec_img')
    ...
    parser.add_argument("--rec_model_path", type=str, default='/raid/heyc-s21/pytorchOCR/crnn/checkpoints/ch_ptocr_server_v2.0_rec_infer.pth')
